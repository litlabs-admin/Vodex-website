 ...
 *
 * Background photo + dark scrim added per explicit user request — the
 * reference itself is a pixel-confirmed flat `--ink` fill, same treatment
 * already given to this banner's own copy-adapted sibling,
 * InvestorContactBanner (§24).
 */
